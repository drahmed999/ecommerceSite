...
function HeaderBottom() {
 ...
 <div className="inline-flex"><h3>Copyright<Copyright/>2022<span className="text-black hidden sm:block font-bold">  Dentistry Decoded</span></h3></div>
 <div className="hidden sm:block"><h3>Design by:<span className="text-black font-extrabold p-3"> Panacloud</span></h3></div>
 <div><h3>Code by: <Link href={"https://drahmed.vercel.app/"} className="font-bold text-blue-950 hover:underline hover:scale-110 duration-300">Dr. Ahmed</Link></h3></div>
    </div></div>
  )
}
